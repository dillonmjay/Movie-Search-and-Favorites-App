...
async function updateFavoriteCount() {
    ...
    if (loggedInUser) {
        ...
        const response = await fetch(`https://movie-search-and-favorites-co232tdw6.vercel.app/get-favorites?username=${loggedInUser}`);
...
async function addToFavorites(id, title, poster) {
    ...
    if (loggedInUser) {
        ...
        await fetch("https://movie-search-and-favorites-co232tdw6.vercel.app/save-favorites", {
            method: "POST",
...
async function removeFromFavorites(id) {
    ...
    try {
        if (loggedInUser) {
            await fetch("https://movie-search-and-favorites-co232tdw6.vercel.app/remove-favorite", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
...
async function signup() {
    ...
    try {
        const response = await fetch("https://movie-search-and-favorites-co232tdw6.vercel.app/signup", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
async function login() {
    ...
    try {
        const response = await fetch("https://movie-search-and-favorites-co232tdw6.vercel.app/login", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ username, password })
        });
...
async function generateShareLink() {
    ...
    const response = await fetch(`https://movie-search-and-favorites-co232tdw6.vercel.app/get-user-id?username=${loggedInUser}`);
    const data = await response.json();
    ...
    const shareURL = `https://movie-search-and-favorites-co232tdw6.vercel.app/favourites.html?id=${userID}`;
